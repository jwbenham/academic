...
/**
 * The routine executed by the client handler threads. The task involves
 * verifying that a request is valid HTTP GET request, checking for the
 * requested file, and sending an appropriate response header and data back to
 * the client, then closing the connection.
