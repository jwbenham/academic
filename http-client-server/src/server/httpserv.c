 ...
 * ****************************************************************************/
/** httpserv.c
 *	This provides the implementation for the HTTP server side of the project. 
 * The main thread spawns an additonal I/O thread, which waits for the user to 
 * enter the exit message, indicating the server should shutdown.
